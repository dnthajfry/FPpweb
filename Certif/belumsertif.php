    ...
    <section class="max-w-5xl mx-auto my-10 p-4 bg-white rounded-lg shadow-md">
        <div class="text-center">
            ...
            <p class="text-gray-600 text-lg leading-relaxed pt-6">
                OjoLaliSinau adalah platform edukasi Coding yang memungkinkan pengajar membuat modul pembelajaran Coding online, menyuguhkan materi, kuis, dan ujian; memantau nilai; dan memberikan feedback kepada siswa dalam satu tempat.
            </p>
            ...
            <div class="flex items-center justify-center mt-6">
                ...
                <div class="text-sm">
                    <p class="text-gray-800 font-bold">Teacher OjoLaliSinau</p>
                </div>
            </div>
        </div>
    </section>
